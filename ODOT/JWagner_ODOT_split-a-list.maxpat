...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 975.0, 417.5, 140.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 504.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 88.0, 244.0, 91.0, 22.0 ],
					"text" : "o.select /sublist"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 528.0, 1092.0, 104.0 ],
					"presentation_linecount" : 6,
					"text" : "/sublist/1 : [\"data\", 0, 25, 1000., 0., 19., 0., 0., 0, 150., 3., 0, 250., 3., 0, 350., 2., 0, 500., 19., 0, 500., 3., 0, 1000., 0., 0, \"linear\"],\n/sublist/2 : [\"data\", 1, 22, 1000., 0., 19., 0., 0., 0, 150., 5., 0, 250., 5., 0, 350., 5., 0, 600., 17., 0, 1000., 0., 0, \"linear\"],\n/sublist/3 : [\"data\", 2, 25, 1000., 0., 19., 0., 0., 0, 150., 7., 0, 250., 8., 0, 350., 9., 0, 600., 9., 0, 750., 13., 2, 963.934, 0., 0, \"linear\"],\n/sublist/4 : [\"data\", 3, 31, 1000., 0., 19., 0., 0., 0, 150., 9., 0, 250., 10., 0, 439.344, 0., 0, 600., 5., 0, 708.197, 0., 0, 757.377, 0., 0, 850., 20., 0, 1000., 0., 0, \"linear\"],\n/sublist/5 : [\"data\", 4, 16, 1000., 0., 19., 0., 10., 0, 150., 10., 0, 250., 10., 0, 600., 12., 0]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 33.0, 385.0, 940.0, 116.0 ],
					"presentation_linecount" : 7,
					"text" : "/comp=\"lambda([i,j], strcmp(i, /mc_function[[j]])==0)\",\n/ind=map(/comp, nfill(133, \"data\"), aseq(0, length(/mc_function)-1)),\n/indx=[],\n/indx=map( lambda(i, if(/ind[[i]], list(/indx, i))), aseq(0, length(/mc_function)-1)),\n/ind=/indx,\n/ind=list(/ind, length(/mc_function)-1),\nmap(lambda(i, assign(\"/sublist/\" + i, nth(/mc_function, aseq(/ind[[i-1]], /ind[[i]]-1)))), aseq(1, length(/mc_function)-1))"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1025.0, 178.0, 150.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 271.0, 1087.0, 104.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 88.0, 166.5, 940.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 31.0, 630.0, 122.0 ],
